...
class DataFreshnessMonitor:
    ...
    def check_data_freshness(
        self, source: str, competition: str, season: str, max_age_hours: int = 24
    ) -> Dict[str, Any]:
        """
    ...
    def detect_data_changes(
        ...
        count_changed = (
            ...
            and current_record_count is not None
            and previous_count != current_record_count
        )
...
class DataQualityTrend:
    ...
    def record_quality_metrics(
        self, source: str, competition: str, season: str, metrics: Dict[str, Any]
    ):
        """
    ...
    def get_quality_trend(
        self, source: str, competition: str, season: str, days_back: int = 30
    ) -> Dict[str, Any]:
        """
        ...
        completeness_scores = [
            entry.get("completeness", 1.0) for entry in recent_history
        ]
        ...
        trend_analysis = {
            ...
            "average_warnings": (
                sum(warning_counts) / len(warning_counts) if warning_counts else 0
            ),
...
class SourceHealthMonitor:
    ...
    def check_source_health(
        self, source_name: str, url: str, timeout: int = 30
    ) -> Dict[str, Any]:
        """
