...
def main():
    ...
    validation_report = pb.validate_fixtures(
        fixtures_df, competition="Premier League", season="2023-2024"
    )
    ...
    cross_validation_report = pb.cross_validate_sources(
        source1_df, source2_df, source1_name="FBRef", source2_name="FootballData"
    )
    ...
    pb.record_data_fetch(
        source="fbref", competition="Premier League", season="2023-2024", df=fixtures_df
    )
    ...
    data_sources = {
        ...
        "footballdata_2023": fixtures_df.assign(
            source="footballdata", season="2023-2024"
        ),
    ...
    coverage_report = validator.validate_historical_coverage(
        data_sources, required_seasons=required_seasons
    )
