...
class TestDataQualityValidator:
    ...
    def test_cross_validate_sources(self):
        ...
        validator = DataQualityValidator(strict_mode=False)
        report = validator.cross_validate_sources(
...
class TestDataFreshnessMonitor:
    ...
    def test_record_and_check_freshness(self, tmp_path):
        ...
        # Record a data fetch
        monitor.record_data_fetch(
            "fbref", "Premier League", "2022-2023", data_hash="abc123", record_count=380
        )

        # Check freshness immediately (should be fresh)
        freshness = monitor.check_data_freshness(
            "fbref", "Premier League", "2022-2023", max_age_hours=24
        )
    ...
    def test_data_change_detection(self, tmp_path):
        ...
        changes = monitor.detect_data_changes(
            "fbref",
            "Premier League",
            "2022-2023",
...
class TestDataFrameHashing:
    ...
    def test_different_dataframes_different_hash(self):
        ...
        df2 = pd.DataFrame({"a": [1, 2, 4], "b": ["x", "y", "z"]})  # Different value
